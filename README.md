...
This project has some case studies on Spring AOP.

You can find Spring Aspect configuration classes of the project which was placed 
in `com.berkanterdogan.lab.springaoplab.config.aspect` package.
